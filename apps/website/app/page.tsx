...
export default function Page() {
  return (
    <main className="flex flex-1 flex-col items-center justify-center py-5 container">
      ...
      <q className="text-center text-4xl font-semibold text-primary-700 dark:text-primary-500">
        The best in class lobby manager for Discord
      </q>
      <h2 className="text-center text-3xl text-primary-600 dark:text-primary-300">
        - obamna
      </h2>
