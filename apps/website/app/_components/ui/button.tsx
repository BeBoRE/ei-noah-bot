  ...
  'inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-primary-950 dark:focus-visible:ring-primary-300',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-primary-200 bg-white hover:bg-primary-50 hover:text-primary-900 dark:border-primary-800 dark:bg-primary-950 dark:hover:bg-primary-800 dark:hover:text-primary-50',
        secondary:
          'bg-primary-50 text-primary-900 hover:bg-primary-50/50 dark:bg-primary-800 dark:text-primary-50 dark:hover:bg-primary-800/80',
        ghost:
