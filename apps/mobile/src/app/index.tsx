...
import {
  ChannelType, generateLobbyName, lobbyChangeSchema, userIdToPusherChannel,
} from '@ei/lobby';
...
const getUserImageUrl = (user : { avatar : string, id : string }) => `${RouteBases.cdn}${CDNRoutes.userAvatar(user.id, user.avatar, ImageFormat.PNG)}?size=${128}`;
