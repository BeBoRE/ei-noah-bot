...
import Animated, {
  FadeIn, FadeInDown, FadeInLeft, FadeInRight, FadeOutDown,
    ...
    <Animated.View exiting={FadeOutDown.duration(400)} className="flex-1 flex-col justify-center items-center">
      <ScrollView className="flex-1 py-5 px-2">
        <Animated.Text
          ...
          className="text-center text-primary-300 font-bold text-5xl my-6
        "
        >
        ...
        <Animated.Text entering={FadeIn.duration(600).delay(4600)} className="text-center text-primary-300 font-semibold text-xl mt-5">
