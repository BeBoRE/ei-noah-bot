...
export class Migration20220518131740 extends Migration {

  async up(): Promise<void> {
    this.addSql('alter table "user_corona_regions" drop constraint "userRegion";');
    this.addSql('alter table "user_corona_regions" add constraint "userRegion" unique ("user_id");');
    ...
    this.addSql('alter table "corona_data" add constraint "dateCommunity" unique ("date");');
  }
